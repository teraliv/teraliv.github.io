...
function create() {
    ...
    // console.log(game.physics.arcade.angleBetweenCenters(group, leader));
    // game.input.mousePointer.rightButton.onDown.add(mouseRightClick, this);
    // group.angle = game.physics.arcade.angleBetweenCenters(group, leader);
